...
public class UserNameRecognizer {
	 ...
	 * 
	 * <p> Copyright: Lynx Robert Carter © 2024 </p>
	 * 
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				// . -> State 2
				else if (currentChar == '.' || currentChar == '_' || currentChar == '-') {							// Checking for .,-,_
					nextState = 2;
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period, a underscore, or a minus sign must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
